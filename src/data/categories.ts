...
export const CATEGORIES: Category[] = [
  {
    ...
    icon: '🏃',
    sampleWords: ['sprint', 'backlog', 'velocity', 'standup', 'epic'],
    words: [
      ...
      'CI/CD', 'demo', 'stakeholder', 'prioritize', 'scope creep',
      'sprint goal', 'daily scrum', 'planning poker',
    ],
  },
  {
    id: 'corporate',
    ...
    icon: '💼',
    sampleWords: ['synergy', 'leverage', 'circle back', 'bandwidth', 'ROI'],
    words: [
  ...
  },
  {
    ...
    icon: '💻',
    sampleWords: ['API', 'cloud', 'microservices', 'DevOps', 'kubernetes'],
    words: [
